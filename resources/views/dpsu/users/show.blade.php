    ...
    <div class="row">
        <div class="col-md-9">
            ...
            <div class="row justify-content-center">
                @if(Route::currentRouteName() == 'dpsu.users.confirm-delete')
                    <div class="col-md-8">
                        <div class="card card-default">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('dpsu.users.delete', $userrole->id ) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('DELETE')

                                    <p>
                                        This action removes access for <strong>{{ $userrole->user->username }}</strong>
                                        from the DPSU portal.
                                    </p>
