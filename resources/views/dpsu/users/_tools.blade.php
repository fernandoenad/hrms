<div class="card card-info">
    ...
    <div class="card-body p-0">
        <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
                <a href="{{ route('dpsu.users.create') }}" class="nav-link">
                    <i class="fas fa-user-plus"></i> New entry
                </a>
            </li>
            @if(Route::currentRouteName() == 'dpsu.users.show' ||
                Route::currentRouteName() == 'dpsu.users.edit' ||
                Route::currentRouteName() == 'dpsu.users.reset' ||
                Route::currentRouteName() == 'dpsu.users.confirm-delete') 
                <li class="nav-item">
                    <a href="#" class="nav-link">
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('dpsu.users.edit', $userrole->id ) }}" class="nav-link">
                        <i class="fas fa-user-edit"></i> Modify user
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('dpsu.users.confirm-delete', $userrole->id)}}" class="nav-link">
