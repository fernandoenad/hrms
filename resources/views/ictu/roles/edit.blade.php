    ...
    <div class="row">
        <div class="col-md-9">
            <div class="card card-primary">
                <div class="card-body">
                    <form method="POST" action="{{ route('ictu.roles.update', $userrole->id) }}">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input readonly id="route" type="text" class="form-control @error('route') is-invalid @enderror" name="route" value="{{ old('route') ?? $userrole->route }}" autocomplete="route">
