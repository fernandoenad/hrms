        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('pu.users') }}">Users</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('pu.users.create') }}">New User</a></li>
            ...
            <div class="card card-outline card-primary">
                <div class="card-header pr-3">
                    <div class="float-right">
                        <form class="form-inline" method="post" action="{{ route('pu.users.lookup') }}">
                            @csrf
                                ...
                                @if(sizeof($employees) > 0)
                                    @foreach($employees as $employee)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('pu.users.create')}}?id={{ $employee->person->user->id }}&name={{ $employee->person->getFullnameBox() }}">
