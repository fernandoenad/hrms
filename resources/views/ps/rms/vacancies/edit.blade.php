...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Modify Vacancy</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Modify Vacancy</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-9">
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('ps.rms.vacancies-update', $vacancy->id) }}">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input list="names" id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') ?? $vacancy->name ?? ''  }}" autocomplete="name">
                            <datalist id="names">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select id="salarygrade" type="text" class="form-control @error('salarygrade') is-invalid @enderror" name="salarygrade" value="{{ old('salarygrade') }}" autocomplete="salarygrade">
                                ...
                                @for($i=1; $i<=24; $i++)
                                    <option value="{{ $i }}" @if(old('salarygrade') ==  $i || $vacancy->salarygrade == $i) {{ 'selected' }} @endif>{{ $i }}</option>
                                @endfor
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select id="vacancylevel" type="text" class="form-control @error('vacancylevel') is-invalid @enderror" name="vacancylevel" value="{{ old('vacancylevel') }}" autocomplete="vacancylevel">
                                <option value="">Select</option>
                                <option value="1" @if(old('vacancylevel') == 1 || $vacancy->vacancylevel == 1) {{ 'selected' }} @endif>School</option>
                                <option value="2" @if(old('vacancylevel') == 2 || $vacancy->vacancylevel == 2) {{ 'selected' }} @endif>District</option>
                                <option value="3" @if(old('vacancylevel') == 3 || $vacancy->vacancylevel == 3) {{ 'selected' }} @endif>Division</option>
                            </select>
                        ...
                        <div class="col-md-8">
                            <select id="curricularlevel" type="text" class="form-control @error('curricularlevel') is-invalid @enderror" name="curricularlevel" value="{{ old('curricularlevel') }}" autocomplete="curricularlevel">
                                ...
                                @foreach($itemlevels as $itemlevel)
                                    <option value="{{ $itemlevel->details }}" @if(old('curricularlevel') == $itemlevel->details || $vacancy->curricularlevel == $itemlevel->details) {{ 'selected' }} @endif>{{ $itemlevel->details ?? '' }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <textarea id="mytextarea-vacancy" class="form-control @error('qualifications') is-invalid @enderror" name="qualifications" value="" autocomplete="qualifications">{{ old('qualifications') ?? $vacancy->qualifications ?? '' }}</textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input id="vacancy" type="number" class="form-control @error('vacancy') is-invalid @enderror" name="vacancy" value="{{ old('vacancy') ?? $vacancy->vacancy ?? '' }}" autocomplete="vacancy">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <div class="custom-control custom-switch custom-switch-off-mute custom-switch-on-success">
                                    <input type="checkbox" class="custom-control-input" id="customSwitch3" type="number" class="form-control @error('status') is-invalid @enderror" name="status" value="1" autocomplete="status" @if(old('status') !== null || $vacancy->status === 1) {{ 'checked' }} @else {{ '' }} @endif>
