...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Deactivate Item</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Deactivate Item</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row">       
        <div class="col-md-9">
            ...
            <div class="card card-primary">
                <div class="card-body">
                    <form method="POST" action="{{ route('ps.items.deactivate-done', $item->id) }}">
                        @csrf
                        @method('PATCH')

                        <h5>Confirm de-activation by filling out the remarks field below.</h5>
                        <br>
