...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Deployment</h1>
            </div>
            <div class="col-sm-6">
                            ...
                            <tbody>
                                @if(sizeof($offices) > 0)
                                    @foreach($offices as $office)
                                        <tr>
                                            <td>
                                                <a href="{{ route('ps.reports.deployment.office', $office->id) }}">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-right">
                                            {{ number_format(\App\Http\Controllers\PS\ReportController::getEmployeesOffice('%', 'deployment')->count(), 0) }}
                                        </th>
                                    </tr>
                                @else 
                                    <tr>
