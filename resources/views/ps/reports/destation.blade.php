        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('ps.reports.deployment') }}">Plantilla</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('ps.reports.deployment.office', $office->id) }}">{{ $office->name }}</a></li>
