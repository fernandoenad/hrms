        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('ps.people.employ', $person->id) }}">Employ</a></li>
            ...
            <div class="card card-outline card-primary">
                <div class="card-header pr-3">
                    <div class="float-right">
                        <form class="form-inline" method="post" action="{{ route('ps.people.lookup-item', $person->id) }}">
                            @csrf
                                ...
                                @if(sizeof($items) > 0)
                                    @foreach($items as $item)
                                        <tr>
                                            <td>
                                                <strong>
                                                    <a href="{{ route('ps.people.employ', $person->id) }}?id={{ $item->id }}&name={{ $item->itemno }}">
                                                        {{ $item->itemno }}
                                                    </a>
                                                </strong>
                                            </td>
