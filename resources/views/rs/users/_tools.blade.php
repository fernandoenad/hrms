    ...
    <div class="card-body p-0">
        <ul class="nav nav-pills flex-column">
            <li class="nav-item active p-3">
                <form class="form-inline" method="post" action="{{ route('rs.users.search') }}">
                    @csrf
            ...
            <li class="nav-item">
                <a href="{{ route('rs.users.create') }}" class="nav-link">
                    <i class="fas fa-user-plus"></i> New entry
                </a>
            </li>
            @if(Route::currentRouteName() == 'rs.users.show' ||
                Route::currentRouteName() == 'rs.users.edit' ||
                Route::currentRouteName() == 'rs.users.reset' ||
                Route::currentRouteName() == 'rs.users.confirm-delete') 
                <li class="nav-item">
                    <a href="#" class="nav-link">
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('rs.users.edit', $userrole->id ) }}" class="nav-link">
                        <i class="fas fa-user-edit"></i> Modify user
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('rs.users.confirm-delete', $userrole->id)}}" class="nav-link">
