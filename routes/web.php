...
Route::middleware(['default.password', 'verified'])->group(function () {
    ...
    Route::middleware(['office.user'])->group(function () {
        ...
        */ 
        ...
        Route::post('/ou/office/{office}/pw/lookup', [OFUserController::class, 'pwLookup'])->name('ou.office.pw.lookup');
        Route::get('/ou/office/{office}/pw/lookup', [OFUserController::class, 'pwLookup'])->name('ou.office.pw.lookup');
