...
class UserController extends Controller
{
    ...
    {
        $user_roles = UserRole::where('route', '=', 'rs')
            ->orderBy('role_id', 'asc')
            ->orderBy('id', 'asc')
            ->get();
        ...
        return view('rs.users.index', compact('user_roles', 'manager_count', 'user_count'));
    }

    public function countRole($role_id)
    {
        $count = UserRole::where('route', '=', 'rs')
    ...
    public function create()
    {
        ...
        return view('rs.users.create', compact('userroles', 'employees'));
    }

    public function show(UserRole $userrole)
    {
        return view('rs.users.show', compact('userrole'));
    }
    ...
    public function store()
    {
        ...
        return redirect()->route('rs.users.show', compact('userrole'))->with('status', 'User created!');
    }

    public function edit(UserRole $userrole)
    {
        return view('rs.users.edit', compact('userrole'));
    }   
    ...
    public function update(UserRole $userrole)
    {
        ...
        return redirect()->route('rs.users.show', compact('userrole'))->with('status', 'User updated!');
    } 
    ...
    public function lookup()
    {
        ...
        return view('rs.users.lookup', compact('employees'));
    } 
    ...
    public function delete(UserRole $userrole)
    {
        ...
        return redirect()->route('rs.users')->with('status', 'User deleted!');
    }
