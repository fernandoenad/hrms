...
class UserController extends Controller
{
    ...
    {
        $user_roles = UserRole::where('route', '=', 'pu')
            ->orderBy('role_id', 'asc')
            ->orderBy('id', 'asc')
            ->get();
        ...
        return view('pu.users.index', compact('user_roles', 'manager_count', 'user_count'));
    }

    public function countRole($role_id)
    {
        $count = UserRole::where('route', '=', 'pu')
    ...
    public function create()
    {
        ...
        return view('pu.users.create', compact('userroles', 'employees'));
    }

    public function show(UserRole $userrole)
    {
        return view('pu.users.show', compact('userrole'));
    }
    ...
    public function store()
    {
        ...
        return redirect()->route('pu.users.show', compact('userrole'))->with('status', 'User created!');
    }

    public function edit(UserRole $userrole)
    {
        return view('pu.users.edit', compact('userrole'));
    }   
    ...
    public function update(UserRole $userrole)
    {
        ...
        return redirect()->route('pu.users.show', compact('userrole'))->with('status', 'User updated!');
    } 
    ...
    public function lookup()
    {
        ...
        return view('pu.users.lookup', compact('employees'));
    } 
    ...
    public function delete(UserRole $userrole)
    {
        ...
        return redirect()->route('pu.users')->with('status', 'User deleted!');
    }
