...
class UserController extends Controller
{
    ...
    {
        $user_roles = UserRole::where('route', '=', 'ictu')
            ->orderBy('role_id', 'asc')
            ->orderBy('id', 'asc')
            ->get();
        ...
        return view('ictu.users.index', compact('user_roles', 'manager_count', 'user_count'));
    }

    public function countRole($role_id)
    {
        $count = UserRole::where('route', '=', 'ictu')
    ...
    public function create()
    {
        ...
        return view('ictu.users.create', compact('userroles', 'employees'));
    }

    public function show(UserRole $userrole)
    {
        return view('ictu.users.show', compact('userrole'));
    }
    ...
    public function store()
    {
        ...
        return redirect()->route('ictu.users.show', compact('userrole'))->with('status', 'User created!');
    }

    public function edit(UserRole $userrole)
    {
        return view('ictu.users.edit', compact('userrole'));
    }   
    ...
    public function update(UserRole $userrole)
    {
        ...
        return redirect()->route('ictu.users.show', compact('userrole'))->with('status', 'User updated!');
    } 
    ...
    public function lookup()
    {
        ...
        return view('ictu.users.lookup', compact('employees'));
    } 
    ...
    public function delete(UserRole $userrole)
    {
        ...
        return redirect()->route('ictu.users')->with('status', 'User deleted!');
    }
